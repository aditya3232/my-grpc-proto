...
const file_proto_transaction_cart_proto_rawDesc = "" +
	"\n" +
	"\x1cproto/transaction/cart.proto\x12\vtransaction\"~\n" +
	"\bCartItem\x12\x1c\n" +
	"\titem_uuid\x18\x01 \x01(\tR\titem_uuid\x12\x1a\n" +
	...
	"\x05items\x18\x02 \x03(\v2\x15.transaction.CartItemR\x05itemsB=Z;github.com/aditya3232/my-grpc-proto/protogen/go/transactionb\x06proto3"

var (
	file_proto_transaction_cart_proto_rawDescOnce sync.Once
	file_proto_transaction_cart_proto_rawDescData []byte
)

func file_proto_transaction_cart_proto_rawDescGZIP() []byte {
	file_proto_transaction_cart_proto_rawDescOnce.Do(func() {
		file_proto_transaction_cart_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_transaction_cart_proto_rawDesc), len(file_proto_transaction_cart_proto_rawDesc)))
	})
...
func file_proto_transaction_cart_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_transaction_cart_proto_rawDesc), len(file_proto_transaction_cart_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
